        ...
        <ul class=" font-medium" >
            ...
            <li class="p-4  rounded-full">
                <span class=" flex items-center justify-center p-2 text-gray-900 rounded-lg transition duration-100" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example" x-data="{ sidebarOpen: false }" @click="sidebarOpen = !sidebarOpen">
                    ...
                    <span class=" flex-1 ml-3 whitespace-nowrap font-poppins tracking-tight font-medium hover:text-white hover:text-lg" x-show="!iconOnly">Orders</span>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2 transition duration-100 " x-show="sidebarOpen">
                    <li>
                        <a href="#" class="flex items-center w-full p-2 font-poppins hover:text-white hover:text-lg tracking-tight text-gray-900 transition duration-75 rounded-lg pl-11 group ">List</a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center w-full p-2 font-poppins hover:text-white hover:text-lg tracking-tight text-gray-900 transition duration-75 rounded-lg pl-11 group ">Details</a>
                    </li>
                </ul>
            </li>
            <li class="p-4  rounded-full">
