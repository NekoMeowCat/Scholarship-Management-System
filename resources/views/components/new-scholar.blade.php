<div class="flex-auto px-4 lg:px-10 py-10 pt-0">
    ...
    @endif
    <form method="POST" action="{{ route('admin.add-scholar') }}" enctype="multipart/form-data">
        @csrf
        <div class="py-6">
        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full lg:w-4/12 px-4">
                ...
                <input type="text" name="first_name" id="first_name" class="border-0 px-3 py-3 text-gray-400 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="Juan">
                </div>
            </div>
        </div>
        <div class="flex flex-wrap">
            ...
            <div class="w-full lg:w-4/12 px-4">
                <div class="relative w-full mb-6">
                    ...
                    <select name="department_id" id="department_id" class="w-full py-3 px-4 pe-9 block border-gray-200 text-gray-700 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                        ...
                        @foreach(collect($departments)->pluck('name') as $department)
        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full lg:w-4/12 px-4">
                <div class="relative w-full mb-6">
                    ...
                    <select name="scholarship_category_id" id="scholarship_category_id" class="w-full py-3 px-4 pe-9 block border-gray-200 text-gray-700 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-2 mt-4">
            <div class="block">          
                <label class="block mb-2 text-sm font-medium " for="file_input">ID</label>
                    <input name="student_id" id="student_id" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" required>
            ...
            <div class="block">          
                <label class="block mb-2 text-sm font-medium " for="file_input">Transcript of Records</label>
                    <input name="transcript_of_records" id="transcript_of_records" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" required>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
            </div>

            <div class="block">          
                <label class="block mb-2 text-sm font-medium " for="file_input">Certificate Of Enrollment</label>
                    <input name="certificate_of_enrollment" id="certificate_of_enrollment" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" required>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
            </div>

            <div class="block">          
                <label class="block mb-2 text-sm font-medium " for="file_input">Grade Slip</label>
                    <input name="grade_slip" id="grade_slip" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" required>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
            </div>

            <div class="block">          
                <label class="block mb-2 text-sm font-medium " for="file_input">Income Tax Return </label>
                    <input name="income_tax_return" id="income_tax_return" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" required>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
            </div>

            <div class="block">          
                <label class="block mb-2 text-sm font-medium " for="file_input">Cert. Of Indegency</label>
                    <input name="certificate_of_indegency" id="certificate_of_indegency" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" required>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
            </div>

            <div class="block">          
                <label class="block mb-2 text-sm font-medium " for="file_input">Statement Of Account</label>
                    <input name="statement_of_accounts" id="statement_of_accounts" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" required>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
            </div>

            <div class="block">          
                <label class="block mb-2 text-sm font-medium " for="file_input">Birth Certificate</label>
                    <input name="birth_certificate" id="birth_certificate" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" required>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
            </div>

            <div class="block">          
                <label class="block mb-2 text-sm font-medium " for="file_input">Good Moral</label>
                    <input name="good_moral" id="good_moral" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" required>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
            </div>

            <div class="block">          
                <label class="block mb-2 text-sm font-medium " for="file_input">Application Form</label>
                    <input name="application_form" id="application_form" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" required>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
            </div>

            <div class="block">          
                <label class="block mb-2 text-sm font-medium " for="file_input">Essay</label>
                    <input name="essay" id="essay" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" required>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
            </div>

            <div class="block">          
                <label class="block mb-2 text-sm font-medium " for="file_input">Endorsement</label>
                    <input name="endorsement" id="endorsement" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" required>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
            </div>
        </div>     
