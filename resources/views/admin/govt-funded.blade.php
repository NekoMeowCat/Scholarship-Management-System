            ...
            <div class="min-h-screen flex-1 m-2">
                <div class="h-10 m-2 flex items-center ">
                    <ol class="flex items-center whitespace-nowrap" aria-label="Breadcrumb">
                        ...
                        <li class="inline-flex items-center">
                            <a class="flex items-center font-medium text-sm text-gray-700" href="{{ route('private-funded') }}">
                                Government Funded
                            </a>
                        </li>
                    </ol>
                ...
                <div class="flex capitalize rounded-md bg-[#f5f5f5] m-2 my-6">
                    <span class="capitalize text-gray-600 text-2xl">government organization funded</span>
                </div>
                <div class="grid grid-cols-4 gap-4 border mx-2">
                    <div class="flex flex-col bg-white border shadow-sm rounded-sm dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                        ...
                        <div class="p-4 md:p-5">
                            ...
                            <a class="mt-2 py-2 px-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{ route('ched') }}">
                                View Scholars
                            </a>
                        </div>
                    </div>
                    <div class="flex flex-col bg-white border shadow-sm rounded-sm dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                        ...
                        <div class="p-4 md:p-5">
                            ...
                            <a class="mt-2 py-2 px-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{ route('tes') }}">
                                View Scholars
                            </a>
                        </div>
                    </div>
                    <div class="flex flex-col bg-white border shadow-sm rounded-sm dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                        ...
                        <div class="p-4 md:p-5">
                            ...
                            <a class="mt-2 py-2 px-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{ route('tesda') }}">
                                View Scholars
                            </a>
                        </div>
                    </div>
