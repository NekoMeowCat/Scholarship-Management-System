            ...
            <div class="min-h-screen flex-1 m-2">
                <div class="h-10 m-2 flex items-center">
                    <ol class="flex items-center whitespace-nowrap" aria-label="Breadcrumb">
                        ...
                        <li class="inline-flex items-center">
                            <a class="flex items-center font-semibold text-sm text-gray-800 hover:text-blue-600 focus:outline-none focus:text-blue-600 dark:focus:text-blue-500" href="{{ route('fsuu-funded') }}">
                                Fsuu Funded
                            </a>
                        </li>
                    </ol>
                ...
                <div class="flex capitalize rounded-md bg-[#f5f5f5] m-2 my-6">
                    <span class="capitalize text-gray-600 text-2xl">fsuu funded</span>
                </div>
                <div class="grid grid-cols-4 gap-4 border mx-2">
                    ...
                    <div class="flex flex-col bg-white border shadow-sm rounded-sm dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                        ...
                        <div class="p-4 md:p-5">
                            ...
                            <a class="mt-2 py-2 px-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{ route('sagap') }}">
                                View Scholars
                            </a>
                        </div>
                    </div>
