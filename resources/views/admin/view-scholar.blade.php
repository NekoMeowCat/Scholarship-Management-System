                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <div class="w-full lg:w-4/12 px-2">
                                        <div class="relative w-full mb-6">
                                            ...
                                            <input type="date" name="graduated_at" id="graduated_at" class="border-0 px-3 py-3 text-gray-400 font-poppins bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="{{ $student->scholarDetails->graduated_at }}">
                                        </div>
                                    </div>
                                </div>
